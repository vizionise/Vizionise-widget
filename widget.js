(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = [
      ...
      /* Launcher */
      '.vai-launcher{position:fixed!important;bottom:24px!important;right:24px!important;pointer-events:auto!important;width:58px!important;height:58px!important;border-radius:50%!important;background:linear-gradient(135deg,#00C036,#009929)!important;border:none!important;box-shadow:0 0 25px rgba(0,192,54,.55),0 4px 16px rgba(0,0,0,.5)!important;display:flex!important;align-items:center!important;justify-content:center!important;z-index:99998!important;transition:transform .2s ease,box-shadow .2s ease!important;padding:0!important;margin:0!important}',
      '.vai-launcher:hover{transform:scale(1.08)!important;box-shadow:0 0 36px rgba(0,192,54,.75),0 6px 24px rgba(0,0,0,.5)!important}',
      ...
      '.vai-header-avatar{width:38px!important;height:38px!important;border-radius:50%!important;background:#00C036!important;border:1px solid #00C036!important;display:flex!important;align-items:center!important;justify-content:center!important;flex-shrink:0!important;overflow:hidden!important}',
      ...
      '.vai-header-status{color:#00C036!important;font-size:11px!important;display:flex!important;align-items:center!important;gap:4px!important;margin:2px 0 0!important}',
      '.vai-status-dot{width:6px!important;height:6px!important;border-radius:50%!important;background:#00C036!important;animation:vai-pulse 2s infinite!important}',
      ...
      '.vai-messages::-webkit-scrollbar-thumb{background:rgba(0,192,54,.2);border-radius:4px}',
      ...
      '.vai-prompt-chip:hover{background:rgba(0,192,54,.08)!important;border-color:rgba(0,192,54,.4)!important;color:#fff!important}',
      ...
      '.vai-message.vai-user .vai-bubble{background:linear-gradient(135deg,#00C036,#009929)!important;color:#000!important;font-weight:500!important;border-bottom-right-radius:4px!important}',
      ...
      '.vai-error-phone{display:inline-block!important;margin-top:8px!important;color:#000!important;background:linear-gradient(135deg,#00C036,#009929)!important;padding:6px 16px!important;border-radius:20px!important;font-weight:700!important;font-size:13px!important;text-decoration:none!important;letter-spacing:.02em!important}',
      ...
      '.vai-input:focus{border-color:#00C036!important;box-shadow:0 0 0 2px rgba(0,192,54,.12)!important;outline:none!important}',
      '.vai-send-btn{width:38px!important;height:38px!important;background:linear-gradient(135deg,#00C036,#009929)!important;border:none!important;border-radius:10px!important;display:flex!important;align-items:center!important;justify-content:center!important;flex-shrink:0!important;transition:transform .15s ease,box-shadow .15s ease!important;padding:0!important;margin:0!important}',
      '.vai-send-btn:hover{transform:scale(1.06)!important;box-shadow:0 0 14px rgba(0,192,54,.5)!important}',
